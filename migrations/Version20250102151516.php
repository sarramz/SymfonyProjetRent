 ...
 */
final class Version20250102151516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE immobilier (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, prix DOUBLE PRECISION NOT NULL, description VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, nbr_chambres INT NOT NULL, statut INT NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_142D24D2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
